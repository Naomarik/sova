...
| [12-settings-dialog.md](12-settings-dialog.md) | §12 · Settings dialog | The gear in the sidebar foot, the tabbed modal it opens, the model policy screen (what may be used, and what subagents may be given), and Modes → Delegate (which worker each kind of Delegate work goes to). |
