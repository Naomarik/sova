---
title: Capture Sova screenshots
...
<!-- Generated by the Sova marketing playbook from .sova/marketing/brand.json and templates/demo-screenshots.md. Edits here are replaced on the next run: change brand.json and re-run the generator (see .sova/marketing/TOOLS.md). -->

# Capture Sova screenshots
...
5. **Where they'll be used.** README (one or two), the site's home (one hero), social (the
   platforms crop differently; see **Write Sova announcement posts**).
