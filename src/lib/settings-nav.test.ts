...
test("Modes sits after Models in the rail, and the dialog's rail is this list", () => {
  assert.deepEqual([...SETTINGS_TABS], ["general", "models", "modes", "summaries", "themes", "mesh", "experimental"]);
